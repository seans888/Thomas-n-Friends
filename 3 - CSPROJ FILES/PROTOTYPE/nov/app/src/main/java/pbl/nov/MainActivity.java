...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        */
        ...
        //Scroll
        float scrollDistanceX = Math.abs(fX - sX);
        float scrollDistanceY = Math.abs(fY - sY);
        long Duration = (upTime - event.getDownTime());
        ...
        textView.setText(
                "\n\nON TOUCHEVENT"
                        ...
                        + "\nswipeDurationX : " + swipeDurationX
                        + "\nswipeDistanceY : " + swipeDistanceY
                        + "\nswipeDurationY : " + swipeDurationY
        );
    ...
    public void swipeXFunc(float swipeDistanceX, long swipeDuration) {
