...
public class DoubleTap extends AppCompatActivity implements
    ...
    List<DoubleTap.TapData> Data = new ArrayList<DoubleTap.TapData>();
...
//        });
        ...
        submitData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tapCount == 0) {
                    Toast.makeText(DoubleTap.this, "No Gesture Yet", Toast.LENGTH_SHORT).show();
                } else {
                    nextCount++;
                ...
                if (nextCount == 5){
                    ...
                    Intent intent = new Intent(DoubleTap.this, LongPress.class);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (touchDuration < 500) {
            ...
            if (Math.abs(curPos - downPos) > singleTapRadius) {
                ...
                DoubleTap.TapData data = new DoubleTap.TapData();
